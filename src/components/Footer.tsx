...
const Footer: React.FC = () => {
  ...
  const lastUpdated = new Date(__BUILD_DATE__).toLocaleDateString(
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <div className="flex gap-4">
          <a
            ...
            aria-label="GitHub"
            className="text-white/40 dark:text-slate-500 hover:text-hermes-400 dark:hover:text-hermes-600 transition-colors duration-300"
          >
          ...
          <a
            href="https://www.linkedin.com/in/dominik-bálint/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
            className="text-white/40 dark:text-slate-500 hover:text-hermes-400 dark:hover:text-hermes-600 transition-colors duration-300"
